  ...
  createDirections() {
    ...
    if (this.props.sortType === 'Insertion') {
      /* array of directions will hold 
         ...
         (2) Text for the button below the direction that either moves to teh next direction or closes the modal
      ...
      */
      ...
      this.directions = [
        ...
        ['When the array is sorted, a Submit button will appear in the toolbox. Click it when you are done.', 'Next', 'An arrow pointing at the Submit button in the toolbox', '405px', '760px', 'growRotate270 1s ease-in-out infinite'],
